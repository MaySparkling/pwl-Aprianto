    ...
    <div class="content-grow">
        ...
        <div class="container my-5" style="max-width: 800px;">
            <div class="mb-4 text-center text-md-start">
                <h1 class="main-title mb-1">Tambah Data Dosen</h1>
                ...
                <form action="{{ action([App\Http\Controllers\DosenController::class, 'store']) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="pendidikan_terakhir" class="form-control" placeholder="Masukkan pendidikan terakhir" required>
                        </div>

                        <div class="col-md-6 mb-4">
                            <label class="form-label">Jurusan Id</label>
                            <input type="text" name="jurusan_id" class="form-control" placeholder="Masukkan ID Jurusan" required>
                        </div>
