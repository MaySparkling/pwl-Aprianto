...
<head>
    ...
    <style>
        ...
        color: rgba(255, 255, 255, 0.75) !important; /* Putih sedikit transparan agar elegan */
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
          ...
          <div class="d-flex align-items-center gap-3">
            <form class="d-flex" role="search" action="#" method="get">
              <input class="form-control search-control" name="q" type="search" placeholder="Cari nama/NIP..." aria-label="Search">
        ...
        <div class="container my-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                <div>
                    <h1 class="main-title mb-1">Daftar Dosen</h1>
                    <p class="text-white-50 mb-0">Kelola dan lihat seluruh data dosen aktif</p>
                </div>
                <div>
                    <a href="{{ action([App\Http\Controllers\DosenController::class, 'create']) }}" class="btn btn-create btn-lg">
                        + Tambah Dosen
                    </a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $d->id }}</td>
                                <td class="fw-semibold text-white">{{ $d->fullname }}</td>
                                <td><span class="badge bg-purple text-white px-2 py-1">{{ $d->NIP }}</span></td>
                                <td>{{ $d->NIDN ?? '-' }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ action([App\Http\Controllers\DosenController::class, 'edit'], [$d->id]) }}" class="btn btn-action-edit">Edit</a>
                                        <form action="{{ action([App\Http\Controllers\DosenController::class, 'destroy'], [$d->id]) }}" method="post" class="m-0">
                                            @csrf
