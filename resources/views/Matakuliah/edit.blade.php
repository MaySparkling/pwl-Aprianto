...
<head>
    ...
    <title>SIAKAD - Edit Mata Kuliah</title>
    ...
    <div class="content-grow">
        ...
        <div class="container my-5" style="max-width: 800px;">
            <div class="mb-4 text-center text-md-start">
                <h1 class="main-title mb-1">Edit Data Mata Kuliah</h1>
                ...
                <form action="{{ action([App\Http\Controllers\MatakuliahController::class, 'update'], [$mata_kuliah->id]) }}" method="post">
                    ...
                    <table class="w-100 table-form mb-4">
                        <tr>
                            ...
                            <td width="3%">:</td>
                            <td>
                                <input type="text" name="jurusan_id" value="{{$mata_kuliah->jurusan_id}}" size="30" class="form-control-custom" placeholder="Masukkan ID Jurusan" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Kode MK</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="kode_mk" value="{{$mata_kuliah->kode_mk}}" size="30" class="form-control-custom" placeholder="Masukkan kode mata kuliah" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Nama MK</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="nama_mk" value="{{$mata_kuliah->nama_mk}}" size="30" class="form-control-custom" placeholder="Masukkan nama mata kuliah" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Sks</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="sks" value="{{$mata_kuliah->sks}}" size="30" class="form-control-custom" placeholder="Masukkan beban SKS" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Dosen Id</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="dosen_id" value="{{$mata_kuliah->dosen_id}}" size="30" class="form-control-custom" placeholder="Masukkan ID Dosen pengampu" required>
                            </td>
                        </tr>
                    </table>
