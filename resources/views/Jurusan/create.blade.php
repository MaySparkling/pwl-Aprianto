...
<head>
    ...
    <title>SIAKAD - Tambah Jurusan</title>
    ...
    <div class="content-grow">
        ...
        <div class="container my-5" style="max-width: 800px;">
            <div class="mb-4 text-center text-md-start">
                <h1 class="main-title mb-1">Tambah Data Jurusan</h1>
                ...
                <form action="{{ action([App\Http\Controllers\JurusanController::class, 'store']) }}" method="post">
                    ...
                    <table class="w-100 table-form mb-4">
                        <tr>
                            ...
                            <td width="3%">:</td>
                            <td>
                                <input type="text" name="nama_jurusan" size="30" class="form-control-custom" placeholder="Masukkan nama jurusan" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Kode Jurusan</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="kode_jurusan" size="30" class="form-control-custom" placeholder="Masukkan kode jurusan" required>
                            </td>
                        </tr>
                    </table>
